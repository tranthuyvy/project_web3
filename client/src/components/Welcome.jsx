...
const Input = ({ placeholder, name, type, value, handleChange }) => (
  <input
    ...
    className="my-2 w-full rounded-sm p-4 outline-none bg-transparent text-white border-none text-sm white-glassmorphism"
  />
)
    ...
    <div className='flex w-full justify-center items-center'>
      <div className='flex mf:flex-row flex-col items-start justify-between md:p-15 py-12 px-4'>
        ...
        <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
          <div className="p-3 flex justify-end items-start flex-col rounded-xl h-52 sm:w-80 w-full my-5 eth-card white-glassmorphism">
            ...
            {isLoading
              ...
              : (
                <button
                  ...
                  className="text-white w-full mt-2 border-[1px] p-2 border-[#3d4f7c] hover:bg-[#e35129] rounded-lg cursor-pointer"
                >
                  Send now
                </button>
              )}
